import { FolderApi, InputParams, MonitorParams } from 'tweakpane';
...
type InputValue = boolean | number | string | Point2dObject;
...
export type Settings = Omit<PaneConfig, 'container'> & {
...
type Leaves<T, P extends string | number | symbol = ''> = {
    0: T extends { schema: any }
        ? Join<T, 'schema', Leaves<T['schema']>>
        : never;
